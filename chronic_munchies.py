...
with col2:
    with st.expander("🌿 **What about the munchies?! cannabis?!**"):
        st.markdown("""
        <span style="font-size: 14px;">
        Cannabis triggers munchies as THC activates brain receptors to boost appetite. Your body has a similar system powered by <strong>endocannabinoids</strong> made from arachidonic acid, which is derived(you guessed it!) from linoleic acid—a fat found in many seed oils.<br>
